/*#################################################################################################
	...
	Ablauf:
	Die Ansteuerung des rxbuffers, in den der Master schreiben kann, erfolgt aehnlich wie bei einem normalen I2C-EEPROM.
	Man sendet zunaechst die Bufferposition, an die man schreiben will, und dann die Daten. Die Bufferposition wird
	automatisch hochgezaehlt, sodass man mehrere Datenbytes hintereinander schreiben kann, ohne jedesmal
	die Bufferadresse zu schreiben.
	Um den txbuffer vom Master aus zu lesen, uebertraegt man zunaechst in einem Schreibzugriff die gewuenschte Bufferposition und
	liest dann nach einem repeated start die Daten aus. Die Bufferposition wird automatisch hochgezaehlt, sodass man mehrere
